...
//hide fruit
$("#fruit1").hide("explode", 1000); //slice fruit 
...
function addHearts(){
$("#triaLeft").empty();for(i = 0; i < trialsLeft; i++){ 
$("#triaLeft").append('<img src="images/hearts.png" class="life">'); 
}
}
...
$("#fruit1").show();
chooseFruit(); //choose a random fruit 
$("#fruit1").css({'left' :Math.round(550*Math.random()), 'top' : -30}); //random position

//generate a random step
step = 1+ Math.round(5*Math.random()); //change step//reduce trials by one 
...
$("#startreset").html("Start Game"); //anymorechange button to Start Game
$("#gameOver").show();
